...
# A. CONSUMERS
cons0 = CSV.read("build/input/consumers/PT_cons_ML_MR.csv",DataFrame)
...
# check
plot(Date.(cons.year, cons.month, 1), cons.consumer, group = cons.dist, 
    st = :scatterpath, legend = :right 
)

CSV.write("build/output/PT_cons_MR_ML_clean.csv",cons)